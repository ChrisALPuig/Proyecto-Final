...
public Ticket createTicket(Long userId, String email, String orderId, String subject, String description, List<MultipartFile> attachments) throws IOException {
    ...
    public List<Ticket> getTicketsByUserIdAndOrderId(Long userId, String orderId) {
        return ticketRepository.findByUserIdAndOrderId(userId, orderId);
    }
