...
import CarouselJuegos from "../carousel/CarouselJuegos.tsx";
import "./home.css";
...
const HomeBien: React.FC<HomeBienProps> = ({ initialAuthMode = null }) => {
  ...
  const [registerFieldsError, setRegisterFieldsError] = useState({ email: false, username: false, password: false });
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    setRegisterFieldsError(newFieldsError);
    ...
    try {
      ...
      setRegisterSuccess("Registro exitoso. Inicia sesión con tu correo.");
      setAuthMode("login");
  ...
  return (
    <>
      ...
      <IonModal
        ...
        style={{ '--backdrop-background': 'transparent', '--background': 'transparent' } as any}
        isOpen={authMode !== null}
        onDidDismiss={closeModal}
      >
        <IonContent className="ion-padding auth-modal-content" scrollY={false} style={{ '--background': 'transparent' } as any}>
          {authMode === "login" && (
            ...
            <div className="register-page">
              <form className="register-form" onSubmit={handleRegisterSubmit}>
                ...
                <input
                  ...
                  className={registerFieldsError.email ? "input-error" : ""}
                />
                ...
                <input
                  ...
                  className={registerFieldsError.username ? "input-error" : ""}
                />
                ...
                <input
                  ...
                  className={registerFieldsError.password ? "input-error" : ""}
                />
